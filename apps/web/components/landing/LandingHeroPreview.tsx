/** Desktop product preview — Census-style audience metrics (no stock photography) */
export function LandingHeroPreview() {
  return (
    <div className="relative" aria-hidden>
      <div className="absolute -inset-6 lg:-inset-8 bg-[radial-gradient(ellipse_at_center,rgba(10,102,194,0.08),transparent_70%)] pointer-events-none" />
      <div className="relative rounded-2xl lg:rounded-3xl border border-[var(--color-border)] bg-white shadow-[var(--shadow-xl)] overflow-hidden">
        <div className="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 sm:py-3.5 border-b border-[var(--color-border)] bg-[var(--color-bg-alt)]">
        ...
        <div className="h-28 sm:h-32 bg-gradient-to-br from-[#e8eef4] via-[#f5f5f4] to-[#e2e8f0] border-t border-[var(--color-border)] relative overflow-hidden">
          <div
